...
// directories. It picks the PARENT container that will hold servers (the instance
// name is typed afterwards). Like the rest of the wizard, it only gathers input;
